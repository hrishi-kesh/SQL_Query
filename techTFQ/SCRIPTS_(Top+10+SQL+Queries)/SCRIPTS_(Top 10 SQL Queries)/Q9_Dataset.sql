...
(
    ...
    quantity_ordered    NUMBER CHECK (quantity_ordered > 0),
    price_each          FLOAT,
    sales               FLOAT,
    order_date          DATE,
    status              VARCHAR2(15),
    qtr_id              NUMBER CHECK (qtr_id BETWEEN 1 AND 4),
    month_id            NUMBER CHECK (month_id BETWEEN 1 AND 12),
    year_id             NUMBER,
    Product             VARCHAR2(20),
    customer            VARCHAR2(20),
    deal_size           VARCHAR2(10) CHECK (deal_size IN ('Small', 'Medium', 'Large'))
);
